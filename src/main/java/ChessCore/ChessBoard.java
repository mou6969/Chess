    ...
    public boolean isTherePieceInBetween(Move move) {
        ...
        if (move.isVerticalMove()) {
            ...
            while (true) {
                ...
                if (getPieceAtSquare(SquareFactory.createSquare(file, currentRank)) != null) {
                    return true;
                }
            }
        }
            ...
            while (true) {
                ...
                if (getPieceAtSquare(SquareFactory.createSquare(currentFile, rank)) != null) {
                    return true;
                }
            }
        }
            ...
            while (true) {
                ...
                if (getPieceAtSquare(SquareFactory.createSquare(currentFile, currentRank)) != null) {
                    return true;
                }
            }
        }
